...
function appendTable(event, data) {
    ...
    if (tableBody) {
        ...
        Logger.log(Logger.levelNames.critical, __filename, "Could not get tableBody in appendTable()");
...
function clearAndLoadTable(event, data) {
    Logger.log(Logger.levelNames.critical, __filename, 'ipcRenderer signal received -> tableFile:clearAndLoadItems');
    clearTable(event);
